...
# InnoDB Tunables
set_unless[:mysql][:tunable][:innodb][:buffer_pool_size] 				 = "1G"
set_unless[:mysql][:tunable][:innodb][:additional_mem_pool_size] = "40M"
set_unless[:mysql][:tunable][:innodb][:log_file_size] 					 = "10M"
set_unless[:mysql][:tunable][:innodb][:log_buffer_size] 				 = "4M"
set_unless[:mysql][:tunable][:innodb][:flush_log_at_trx_commit]  = "2"
set_unless[:mysql][:tunable][:innodb][:thread_concurrency] 			 = "32"
set_unless[:mysql][:tunable][:innodb][:flush_method] 						 = "O_DIRECT"
# set_unless[:mysql][:tunable][:innodb][:data_file_path] = "ibdata1:1024M:autoextend"
